...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (nome.isEmpty() || valor.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Campos Vazios. Preencha todos os campos para fazer o cadastro de um novo produto");
        } else {
            if (validaNumeroInteiro(valor)) {
    ...
    private static boolean validaNumeroInteiro(String valor) {
        try {
            int numero = Integer.parseInt(valor);
            return true;
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, "Valor iformado não é um número valido. Por favor, insira um numero inteiro, como 1, 2 ou 3");
            return false;
        }
    }
}
